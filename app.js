...
const modalCopy = {
  ...
  incomeSetup: {
    title: "接入网站收益需要什么",
    copy: "<p>站内收益位置已预留，正式启用前需要真实账号、真实链接和平台审核。</p><ul><li>联盟返佣：淘宝联盟、京东联盟或工具厂商后台生成的推广链接。</li><li>付费资料：小鹅通、知识星球、微店、淘宝虚拟商品等生成的付款链接。</li><li>线索服务：飞书多维表格、Tally、问卷星或其他表单链接。</li><li>广告收益：广告联盟审核后的广告代码，通常要等网站内容和流量稳定。</li></ul><p>拿到任意一个代码或链接后，可以把对应按钮换成正式入口；收益以各平台实际结算为准。</p>",
  },
  adSetup: {
    title: "广告代码接入",
  ...
  affiliateSetup: {
    title: "联盟返佣链接接入",
    copy: "<p>返佣是本站最适合先做的收入入口：用户从清单、榜单或教程点击推广链接，成交后按联盟平台规则结算。</p><ul><li>国内可先看淘宝联盟、京东联盟、SaaS 或 AI 工具推荐计划。</li><li>需要准备：产品名称、推广链接、佣金说明、要放在哪些卡片上。</li><li>页面会标注推荐理由和商业关系，避免误导。</li></ul>",
  },
  paidSetup: {
    title: "付费资料链接接入",
    copy: "<p>资料包适合最快验证付费意愿。本站先卖小额、清楚、可交付的模板，不卖夸大收益课程。</p><ul><li>可卖内容：省钱采购表、简历面试包、商家获客表、标题脚本库。</li><li>国内常用承接方式：小鹅通、知识星球、微店、淘宝虚拟商品或其他正规付款页。</li><li>页面按钮只跳转到付款页，不在本站直接收集银行卡、身份证等敏感信息。</li></ul>",
  },
  leadSetup: {
    title: "线索表单接入",
    copy: "<p>线索成交适合早期现金流：给商家做落地页、表单、通知和回访流程，用户提交后你按需求报价。</p><ul><li>需要：表单平台链接或飞书多维表格链接。</li><li>我能做：把当前表单接到真实数据表，并加自动通知。</li><li>注意：只收必要信息，明确用途，不收敏感信息。</li></ul>",
  },
};
