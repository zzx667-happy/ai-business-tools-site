...
const modalCopy = {
  sponsor: {
    title: "赞助位怎么赚钱",
    copy: "<p>赞助位属于商业合作展示，需要明确标注合作关系、展示周期和素材来源。前期可按周测试，等访问量稳定后再调整报价。</p><ul><li>需要：赞助报价、展示周期、素材授权、收款链接或合同信息。</li><li>页面处理：把赞助内容接到首页、工具页和专题页，并保留广告/赞助标识。</li></ul>",
  },
  free: {
    title: "订阅免费更新",
  ...
  incomeSetup: {
    title: "接入网站收益需要什么",
    copy: "<p>站内收益位置已预留，正式启用前需要实名账号、真实链接和平台审核。</p><ul><li>广告收益：百度联盟或 AdSense 审核后的广告代码。</li><li>返佣收益：淘宝联盟、京东联盟、AI 工具推荐计划生成的推广链接。</li><li>付费资料：小鹅通、知识星球、微店、淘宝虚拟商品等生成的付款链接。</li><li>赞助位：赞助商素材、价格、展示周期、收款方式和合作标识。</li></ul><p>拿到任意一个代码或链接后，可以把对应位置换成正式入口；收益以各平台实际结算为准。</p>",
  },
  adSetup: {
    title: "广告代码接入",
  ...
  affiliateSetup: {
    title: "联盟返佣链接接入",
    copy: "<p>返佣适合工具导航站：用户从工具卡片或教程按钮跳转，成交后按联盟平台规则结算佣金。</p><ul><li>国内可先看淘宝联盟、京东联盟和各类 AI 工具推荐计划。</li><li>需要准备：产品名称、推广链接、佣金说明、想放在哪些卡片上。</li><li>页面处理：把工具详情页按钮替换成返佣链接，并标注推荐理由和商业关系。</li></ul>",
  },
  paidSetup: {
    title: "付费资料链接接入",
    copy: "<p>资料包、模板、清单适合做低价数字产品，但需要清楚说明内容范围、交付方式和退款规则。</p><ul><li>可卖内容：爆款标题库、AI 工具测评表、商单报价话术、30 天更新计划。</li><li>国内常用承接方式：小鹅通、知识星球、微店、淘宝虚拟商品或自有支付页。</li><li>页面处理：站内按钮跳转到正规付款页，不在本站直接收集银行卡、身份证等敏感信息。</li></ul>",
  },
  leadSetup: {
    title: "线索表单接入",
